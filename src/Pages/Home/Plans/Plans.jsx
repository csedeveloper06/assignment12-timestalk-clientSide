          ...
          <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-50">
              <div className="space-y-2">
                <span className="font-bold tracki text-xs p-2 bg-orange-200">
                        Free for 1 month
                </span>
                <h4 className="text-2xl font-bold">Primium Individual</h4>
              ...
              <ul className="flex-1 mb-6 text-gray-600">
                ...
                <li className="flex mb-2 space-x-2">
                  ...
                  <span>15 hours/month of listening time from our audiobooks subscriber catalog</span>
                </li>
              </ul>
              <button
                type="button"
